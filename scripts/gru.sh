...
python -u main.py --model gru --tf_mode force --mode train --epochs 15 --rnn_attn_type concat --emb_dim 512 --dropout 0.5 --hid_dim 512 --dataset_size 100k 2>&1 | tee -a ./logs/gru_force_concat.log
