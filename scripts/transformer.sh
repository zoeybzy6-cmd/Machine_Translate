...
python -u main.py --mode test --model transformer --dataset_size 100k --hid_dim 512 --n_layers 3 --n_heads 8 --pf_dim 2048 --epochs 15 --pos_type absolute --norm_type rmsnorm --decode_strategy beam \
